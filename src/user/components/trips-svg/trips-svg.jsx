...
export default function TripsSvg() {
    return (
        <svg viewBox="0 0 1002 329.98">
            <g style={{ isolation: 'isolate' }}>
                <path
                    ...
                    fill="#ffd46b"
                />
                <path fill="#ffd46b" d="M84.9 91.96h164.23v65.31H84.9z" />
                <path
                    fill="#fff"
                ...
                <path
                    ...
                    fill="#ffd46b"
                />
                <circle cx="167.36" cy="73.82" r="4.61" fill="#ffb436" style={{ mixBlendMode: 'multiply' }} />
                <path
                    fill="#ffb436"
                ...
                />
                <path fill="#ff8e8f" d="M788.35 207.8h35.12v21.67h-35.12z" />
                <path fill="#c6e7e0" d="M823.47 213.74h28.19v15.73h-28.19z" />
                <path
                    d="M894.22 272a5.2 5.2 0 0 0 5.2 5.21v-10.46a5.2 5.2 0 0 0-5.2 5.25zM820.09 257.48h38.1l-8.12-18.95H792.6v18.95h27.49z"
                    fill="#fdf4d3"
                />
                <path fill="none" stroke="#75b4b4" strokeMiterlimit="10" d="M834.07 236.03v25.3M811.65 236.03v24.33" />
                <path
                ...
                <g style={{ mixBlendMode: 'multiply' }}>
                    <circle cx="680.92" cy="163.63" r="45.89" fill="none" stroke="#61a0a0" strokeMiterlimit="10" />
                    <circle cx="680.92" cy="163.63" r="39.44" fill="none" stroke="#61a0a0" strokeMiterlimit="10" />
                    <path fill="none" stroke="#61a0a0" strokeMiterlimit="10" d="M680.92 117.73v91.79" />
                    <path
                        fill="#ffb436"
                        d="M680.92 167.5l-15.9 64.21h31.79l-15.89-64.21z"
                        style={{ mixBlendMode: 'multiply' }}
                    />
                    <circle cx="680.92" cy="105.42" r="6.23" fill="#c6e7e0" style={{ mixBlendMode: 'multiply' }} />
                    <path fill="none" stroke="#61a0a0" strokeLinejoin="round" d="M676.78 117.97l4.14-6.32 4.13 6.32" />
                    <path fill="none" stroke="#61a0a0" strokeMiterlimit="10" d="M648.56 130.95l64.9 64.9" />
                    <circle cx="622.47" cy="163.36" r="6.23" fill="#c6e7e0" style={{ mixBlendMode: 'multiply' }} />
                    <path fill="none" stroke="#61a0a0" strokeLinejoin="round" d="M635.02 167.5l-6.32-4.14 6.32-4.13" />
                    <circle cx="739.36" cy="163.63" r="6.23" fill="#c6e7e0" style={{ mixBlendMode: 'multiply' }} />
                    <path fill="none" stroke="#61a0a0" strokeLinejoin="round" d="M726.81 167.76l6.32-4.13-6.32-4.14" />
                    <circle cx="639.68" cy="122.07" r="6.23" fill="#c6e7e0" style={{ mixBlendMode: 'multiply' }} />
                    <path fill="none" stroke="#61a0a0" strokeLinejoin="round" d="M645.63 133.87l-1.54-7.39 7.39 1.55" />
                    <circle cx="722.15" cy="204.91" r="6.23" fill="#c6e7e0" style={{ mixBlendMode: 'multiply' }} />
                    <path fill="none" stroke="#61a0a0" strokeLinejoin="round" d="M710.35 198.96l7.39 1.55-1.54-7.4" />
                    <path fill="none" stroke="#61a0a0" strokeMiterlimit="10" d="M648.37 195.85l64.9-64.9" />
                    <circle cx="639.5" cy="204.73" r="6.23" fill="#c6e7e0" style={{ mixBlendMode: 'multiply' }} />
                    <path fill="none" stroke="#61a0a0" strokeLinejoin="round" d="M651.3 198.77l-7.4 1.55 1.55-7.39" />
                    <circle cx="722.34" cy="122.26" r="6.23" fill="#c6e7e0" style={{ mixBlendMode: 'multiply' }} />
                    <path fill="none" stroke="#61a0a0" strokeLinejoin="round" d="M716.38 134.06l1.55-7.39-7.39 1.54" />
                    <circle cx="680.92" cy="163.36" r="4.13" fill="#ffb436" style={{ mixBlendMode: 'multiply' }} />
                </g>
                <g fill="none" style={{ mixBlendMode: 'multiply' }}>
                    <circle cx="529.13" cy="172.92" r="14.09" stroke="#61a0a0" strokeMiterlimit="10" />
                    <circle cx="509.77" cy="209.97" r="6.21" stroke="#61a0a0" strokeMiterlimit="10" />
                    <circle cx="529.13" cy="109.63" r="9.92" stroke="#61a0a0" strokeMiterlimit="10" />
                    <circle cx="529.13" cy="88.15" r="4.96" stroke="#61a0a0" strokeMiterlimit="10" />
                    <path stroke="#61a0a0" strokeMiterlimit="10" d="M512.9 204.62l11.27-18.51" />
                    <path
                        stroke="#61a0a0"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                    ...
                    />
                    <circle cx="548.5" cy="209.97" r="6.21" stroke="#61a0a0" strokeMiterlimit="10" />
                    <path stroke="#61a0a0" strokeMiterlimit="10" d="M545.36 204.62l-11.27-18.51" />
                    <path
                        stroke="#61a0a0"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                    ...
                    />
                    <path stroke="#ff5a5f" strokeMiterlimit="10" d="M529.13 83.06V54.43" />
                    <path
                        stroke="#61a0a0"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                ...
                <g>
                    <rect x="370.91" y="105.47" width="11.88" height="11.88" rx="3.26" ry="3.26" fill="#ff8e8f" />
                    <path
                ...
                <g>
                    <path fill="none" stroke="#f9d479" strokeMiterlimit="10" d="M359.72 172.83l.13 56.5" />
                    <path
                ...
                <g>
                    ...
                    <g fill="none" strokeLinecap="round" strokeLinejoin="round">
                        <path stroke="#407f7f" d="M6.35 207.63l52.52-31.96" />
                        <path
                    ...
                    <g strokeLinecap="round" strokeLinejoin="round">
                        <path d="M33.4 213.15l52.53-32s12.71 4 16.73 5.93" fill="none" stroke="#407f7f" />
                        <path
                    ...
                    />
                    <g fill="none" strokeLinecap="round" strokeLinejoin="round">
                        <path stroke="#407f7f" d="M327.04 207.63l-52.53-31.96" />
                        <path
                    ...
                    <g strokeLinecap="round" strokeLinejoin="round">
                        <path d="M300 213.15l-52.52-32s-12.71 4-16.74 5.93" fill="none" stroke="#407f7f" />
                        <path
